...
const baseUrl = 'http://mx' // 基础路径
    ...
    Mock.mock(/http:\/\/mx\/getEx/, function (option) {
        ...
        if (id === '1') {
            return [
                {name: '小红', age: '24', 'beauty': '60'},
                {name: '小花', age: '21', 'beauty': '70'},
            ]
        } else if (id === '2') {
            return [
                {name: '小美', age: '27', beauty: '80'}
            ]
        } else if (id === '3') {
            return [
                {name: '小青', age: '18', beauty: '50'},
                {name: '小雪', age: '20', beauty: '90'},
                {name: '小月', age: '23', beauty: '80'}
            ]
        }
    })
            ...
            items: [
                Ext.create('Ext.grid.Panel', {
                    ...
                    columns: [
                        ...
                        {text: '年纪', dataIndex: 'age', flex: 1, align: 'center'},
                        {text: '颜值', dataIndex: 'beauty', flex: 1, align: 'center'},
                    ],
                    store: Ext.create('Ext.data.Store', {
                        storeId: 'exStore',
                    })
